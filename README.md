...
Os E2E cobrem os recursos da Central de Estudos, incluindo seleção de tópico, busca, anotação dinâmica, persistência após reload, PDF local, estado PWA e viewport mobile.
